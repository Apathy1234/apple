...
(cl:in-package pose_estimate-msg)


;//! \htmlinclude PoseEstimateResult.msg.html

(cl:defclass <PoseEstimateResult> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass PoseEstimateResult (<PoseEstimateResult>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <PoseEstimateResult>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'PoseEstimateResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pose_estimate-msg:<PoseEstimateResult> is deprecated: use pose_estimate-msg:PoseEstimateResult instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <PoseEstimateResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pose_estimate-msg:header-val is deprecated.  Use pose_estimate-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'q0-val :lambda-list '(m))
(cl:defmethod q0-val ((m <PoseEstimateResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pose_estimate-msg:q0-val is deprecated.  Use pose_estimate-msg:q0 instead.")
  (q0 m))

(cl:ensure-generic-function 'q1-val :lambda-list '(m))
(cl:defmethod q1-val ((m <PoseEstimateResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pose_estimate-msg:q1-val is deprecated.  Use pose_estimate-msg:q1 instead.")
  (q1 m))

(cl:ensure-generic-function 'q2-val :lambda-list '(m))
(cl:defmethod q2-val ((m <PoseEstimateResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pose_estimate-msg:q2-val is deprecated.  Use pose_estimate-msg:q2 instead.")
  (q2 m))

(cl:ensure-generic-function 'q3-val :lambda-list '(m))
(cl:defmethod q3-val ((m <PoseEstimateResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pose_estimate-msg:q3-val is deprecated.  Use pose_estimate-msg:q3 instead.")
  (q3 m))

(cl:ensure-generic-function 'tx-val :lambda-list '(m))
(cl:defmethod tx-val ((m <PoseEstimateResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pose_estimate-msg:tx-val is deprecated.  Use pose_estimate-msg:tx instead.")
  (tx m))

(cl:ensure-generic-function 'ty-val :lambda-list '(m))
(cl:defmethod ty-val ((m <PoseEstimateResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pose_estimate-msg:ty-val is deprecated.  Use pose_estimate-msg:ty instead.")
  (ty m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PoseEstimateResult>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PoseEstimateResult>)))
  "Returns string type for a message object of type '<PoseEstimateResult>"
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <PoseEstimateResult>))
  "Converts a ROS message object to a list"
  (cl:list 'PoseEstimateResult
